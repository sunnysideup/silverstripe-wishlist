...
class WishListDecorator_DataObject extends DataObjectDecorator
{
     ...
     * @return boolean
     */
    public function IsOnWishList($object = null)
    {
        if (!$object) {
            $object = $this->owner;
        }
     ...
     */
    public function AddWishListRequirements()
    {
     ...
     * @return Array
     */
    public function WishlistIndexArray()
    {
        return array(
     ...
     * @return String
     */
    public function WishlistIndexString()
    {
...
class WishListDecorator_Controller extends Extension
{
     ...
     * @param string
     */
    public static function set_session_variable_name($v)
    {
     ...
     */
    public static function set_inline_requirements()
    {
     ...
     */
    public static function get_member_for_wishlist()
    {
     ...
     * @return Boolean
     */
    public static function set_wish_list_to_member($array, $force = false)
    {
        if (!is_array($array)) {
     ...
     * @return string | null
     */
    public function retrievewishlist()
    {
     ...
     * @return string
     */
    public function WishListMessage()
    {
        //retrieve message
     ...
     * @return int | null
     */
    public function NumberOfItemsInSavedOnes()
    {
        $array = self::get_wish_list_from_member_array();
     ...
     * @return int | null
     */
    public function NumberOfItemsInSessionOnes()
    {
        $array = self::get_wish_list_from_member_array();
        if (is_array($array) && ($count = count($array))) {
            return $count;
